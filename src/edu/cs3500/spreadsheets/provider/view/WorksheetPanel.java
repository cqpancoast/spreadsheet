...
import edu.cs3500.spreadsheets.model.InvalidCellException;
    ...
    for (int x = 0; x < cellsX; x++) {
      for (int y = 0; y < cellsY; y++) {
        ...
        if (cellX >= 0 && cellY >= 0 && cellX < 5000 && cellY < 5000) {
          ...
          if (model.getNonEmptyCells().containsKey(c)) {
            ...
            try {
              ...
              g2d.setPaint(Color.red);
              g2d.drawString("CELL_ERROR", cellX + 5, cellY + 5 + cellHeight / 2);
            }
          }
        }
      }
